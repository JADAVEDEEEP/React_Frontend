...
export default function RegisterWithNav() {
  ...
  // Inject CSS once
  useEffect(() => {
    if (document.getElementById("pp-embedded-css-register")) return;

    const css = `
      :root { --accent-A: #667eea; --accent-B: #ffd166; --accent-C: #c59b2b; }
      .hp-root { font-family: Inter, system-ui, Arial; min-height:100vh; background:#f7f7fb; display:flex; flex-direction:column; }
    ...
    style.id = "pp-embedded-css-register";
    style.innerHTML = css;
      ...
      <div className="login-card-wrap">
        <div className="login-card">
          ...
          <p className="text-center mb-4" style={{ color: "#6b7280", fontSize: 14 }}>
            Register as a seller on Trendzz
          </p>
          ...
          <p className="text-center mt-3" style={{ color: "#6b7280", fontSize: 14 }}>
            ...
            <a href="/login" style={{ color: accent, fontWeight: 700 }}>
              Login here
            </a>
          </p>
        </div>
